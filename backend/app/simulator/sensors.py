...
STATION_DEFAULTS: dict[str, dict] = {
    ...
    StationId.SHREDDER: {"temp": 55, "vib": 8.0, "gas": 15, "speed": 0.0, "load": 60, "power": 25.0},
    ...
    StationId.LEAD_FURNACE: {"temp": 450, "vib": 4.0, "gas": 35, "speed": 0.0, "load": 70, "power": 85.0},
    StationId.LITHIUM_RECOVERY: {"temp": 60, "vib": 1.5, "gas": 20, "speed": 0.0, "load": 55, "power": 15.0},
    StationId.COPPER_RECOVERY: {"temp": 55, "vib": 1.5, "gas": 12, "speed": 0.0, "load": 50, "power": 12.0},
    StationId.PLASTIC_LINE: {"temp": 180, "vib": 5.0, "gas": 25, "speed": 0.3, "load": 45, "power": 18.0},
